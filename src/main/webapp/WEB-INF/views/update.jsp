...
<html>
  <head>
    ...
    <style type="text/css">
      ...
      #write-field .td2 input[type="text"],
      input[type="password"] {
        height: 28px;
        padding: 3px;
        display: inline-block;
          ...
          <table>
            <tr>
              ...
              <td class="td2">
                ...
                >
                  <option value="JAVA" ${board.category != null && board.category == 'JAVA' ? 'selected' : ''}>JAVA</option>
                  <option value="JAVASCRIPT" ${board.category != null && board.category == 'JAVASCRIPT' ? 'selected' : ''}>JAVASCRIPT</option>
                  <option value="DATABASE" ${board.category != null && board.category == 'DATABASE' ? 'selected' : ''}>DATABASE</option>
                </select>
              </td>
            </tr>
                ...
                <div class="row row-xs-bskr">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-bskr">
                    ...
                    <div class="input-forms">
                      ...
                      <%-- class="form-control input-sm input-name bskr-font
                      user" />--%> <%--
                    </div>
                    --%> <%--
                  </div>
          ...
          <div class="form-group">
            <table>
              ...
              <tr>
                <td class="td1"></td>
                <td class="td2">
                  <input type="file" name="filepath" id="InputFile" />
                </td>
              </tr>
            </table>
          </div>
