...
<div class="container" style="margin-top: 120px">
    <div class="row">
        <div class="main">
            ...
            <c:if test="${not empty errors.existsEmail}">
                <div class="errors">
                    <h4>
                        <c:out value="${errors.existsEmail}"/>
                    </h4>
                </div>
            </c:if>
            <c:if test="${not empty errors.passwordNotMatch}">
                <div class="errors">
                    <h4>
                        <c:out value="${errors.passwordNotMatch}"/>
                    </h4>
                </div>
            </c:if>
            ...
            <form id="signup-form" action="/signup" method="post" role="form">
                ...
                <h6
                        ...
                        align="center"
                >
                    회원가입을 클릭함으로써 <u><br/><a href="#">사용약관</a></u> 및
                    <u><a href="#">개인정보취급방침</a></u> 에 동의합니다.
                </h6>
            </form>
        </div>
    </div>
