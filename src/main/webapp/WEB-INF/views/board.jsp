...
<div class="board-field">
    ...
    <div class="col-md-8">
        <div class="board-toolbar" style="text-align: right; margin-bottom: 20px">
            <form action="/boards" id="search-form" method="get">
                <select name="type" id="search-type">
                    <option value="subject" ${type != null && type == 'subject' ? 'selected' : ''}>제목</option>
                    <option value="writer" ${type != null && type == 'writer' ? 'selected' : ''}>작성자</option>
                </select>
                <input type="text" name="query" id="search-text" value="${query}">
        ...
        <div class="list-group">
            <small>글 갯수: ${totalCount}</small>
            <c:forEach var="board" items="${boards}">
                <a href="/boards/view?boardId=${board.boardId}&type=${type}&query=${query}&page=${page}" class="list-group-item">
                    <div class="board-title">
                        <span class="board-category">[${board.category}]</span>
                            ${board.subject}
                    </div>
